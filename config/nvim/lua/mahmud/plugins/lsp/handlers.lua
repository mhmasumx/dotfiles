...
M.lsp_keymaps = function(bufnr)
  ...
  -- telescope
  vim.keymap.set("n", "gR", function() require("mahmud.plugins.telescope").lsp_references() end, { silent = true, buffer = bufnr, desc = "Show References" })
  vim.keymap.set("n", "gd", function() require("mahmud.plugins.telescope").lsp_definitions() end, { silent = true, buffer = bufnr, desc = "View Definitions" })
  ...
  vim.keymap.set("n", "<leader>K", vim.lsp.buf.signature_help, { silent = true, buffer = bufnr, desc = "Signature Help" })
  ...
  vim.keymap.set("n","[e", M.diagnostic_goto(true, vim.diagnostic.severity.ERROR), { silent = true, buffer = bufnr, desc = "Next Error" })
  vim.keymap.set("n","]e",M.diagnostic_goto(false, vim.diagnostic.severity.ERROR), { silent = true, buffer = bufnr, desc = "Previous Error" })
end
